local function DrawColorBorder(color, x, y, w, h, borderSize)
    ...
    -- Left border
    surface.DrawRect(x, y + borderSize, borderSize, h - 2 * borderSize)

    -- Right border
    surface.DrawRect(x + w - borderSize, y + borderSize, borderSize, h - 2 * borderSize)
end

local function drawSlot(self, w, h)
    DrawColorBorder(Color(78, 78, 78, 169), 0, 0, w, h, 5)
end
